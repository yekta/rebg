...
- `HUGGINGFACE_TOKEN` (or `HF_TOKEN`) only needed for gated models (e.g. `briaai/RMBG-2.0`)
- `BIREFNET_MODEL_ID` (default `ZhengPeng7/BiRefNet_HR-matting`)
